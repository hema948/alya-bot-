...
export async function before(m, { conn }) {
  try {
    ...
    let bannerFinal = 'https://files.catbox.moe/ipr7qr.jpg'
    ...
    if (fs.existsSync(configPath)) {
      try {
        ...
        console.log('⚠️ تعذر قراءة إعدادات الروبوت الفرعي في rcanal:', err)
      }
    }
    ...
    console.log('حدث خطأ أثناء إنشاء rcanal:', e)
  }
}